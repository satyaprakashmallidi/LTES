...
// Sample RAMS documents for display
const allRAMS = [
  {
    id: "RAMS-2024-089",
...
This RAMS has been reviewed and approved for the specified works.`,
  ...
  {
    id: "RAMS-2025-03",
    siteName: "Great Wilbraham Solar Farm",
    ...
    nearestHospital: "Addenbrooke's Hospital, 4.5 miles",
    what3words: "///crisp.glow.solar",
    jobType: "SMA Central Inverter Maintenance - Great Wilbraham 38.1MW",
    content: `RISK ASSESSMENT & METHOD STATEMENT
...
This RAMS has been reviewed and approved for the specified works.`,
  ...
  {
    id: "RAMS-2025-04",
    siteName: "Industrial Park Birmingham",
...
This RAMS has been reviewed and approved for the specified works.`,
  ...
  {
    id: "RAMS-2025-05",
    siteName: "Nationwide Operations",
    jobNumber: "J-2025-005",
    technician: "David Clark",
    dateCreated: "2025-01-16",
    riskLevel: "Medium",
    nearestHospital: "Various - Site Specific",
...
interface RAMSReviewDialogProps {
  open: boolean;
  onOpenChange: (open: boolean) => void;
  ramsId: string;
}

export function RAMSReviewDialog({ open, onOpenChange, ramsId }: RAMSReviewDialogProps) {
  const [currentRAMS, setCurrentRAMS] = useState(allRAMS[0]);
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 mt-4">
          ...
          <div className="lg:col-span-2">
            <Card className="h-full">
              ...
              <CardContent>
                <div className="bg-muted rounded-lg p-4 sm:p-6 max-h-[500px] overflow-y-auto">
                ...
                <CollapsibleContent>
                  <CardContent>
                    ...
                    <p className="text-xs text-muted-foreground mt-3 italic">
                      AI-generated content should always be reviewed and approved by competent personnel before use.
                    </p>
                  </CardContent>
                </CollapsibleContent>
              </Collapsible>
